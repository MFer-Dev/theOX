...
SERVICES=(identity cred discourse purge endorse safety trustgraph notifications search messaging lists gateway ops-gateway ops-agents agents ox-read ox-physics)
URLS=(
...
start_all() {
  ...
  echo "  ox-physics    http://localhost:4019"
}
