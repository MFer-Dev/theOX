...
class SvgViewManager extends ReactViewManager
  ...
  public void setBorderRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 0, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderTopLeftRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 1, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderTopRightRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 2, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderBottomRightRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 3, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderBottomLeftRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 4, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderTopStartRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 5, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderTopEndRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 6, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderBottomStartRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 7, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderBottomEndRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 8, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderEndEndRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 9, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderEndStartRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 10, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderStartEndRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 11, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }

  @Override
  public void setBorderStartStartRadius(SvgView view, Dynamic rawBorderRadius) {
    super.setBorderRadius(view, 12, rawBorderRadius == null ? Float.NaN : (float) rawBorderRadius.asDouble());
  }
}
